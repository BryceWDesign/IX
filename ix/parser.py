...
The parser is intentionally conservative. It accepts the small executable core
that the runtime will support first, plus agent/event/policy structures needed
for the evidence-bound language direction. Unsupported lines fail closed with a
clear syntax error instead of being silently ignored.
"""
